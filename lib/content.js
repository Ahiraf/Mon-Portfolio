...
// Opens a Gmail compose window in a new tab. Works reliably in the browser
// even when the visitor has no default desktop mail app configured (which is
// why a plain `mailto:` link often appears to do nothing).
export const emailHref =
  "https://mail.google.com/mail/?view=cm&fs=1&to=fariharayhanmim@gmail.com";
...
export const socials = [
  ...
  { kind: "email", label: "Email", href: emailHref },
];
...
export const projects = [
  ...
  },
  {
    ...
    image: "/projects/shokhi-health-logo.png",
    screenshots: [],
  ...
  },
  {
    ...
    image: "/projects/portablebrain-ai-logo.png",
    screenshots: [],
    live: "",
